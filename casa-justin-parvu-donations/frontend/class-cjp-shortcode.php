...
class CJP_Shortcode
{
    ...
    public static function render_shortcode(): string
    {
        ...
        <div class="cjp-donations-page" id="cjp-donations-page">
                    ...
                    <?php foreach ($materials as $key => $material) : ?>
                        <article class="cjp-material-card" data-key="<?php echo esc_attr((string) $key); ?>">
                            <div class="cjp-material-header">
                                ...
                                <strong>
                                    <span class="cjp-current"><?php echo esc_html(number_format_i18n((float) ($material['current'] ?? 0), 0)); ?></span>
                                    /
                                    <span class="cjp-target"><?php echo esc_html(number_format_i18n((float) ($material['target'] ?? 0), 0)); ?></span>
            ...
            <!-- 8. Redirecționare 3.5% persoane fizice -->
