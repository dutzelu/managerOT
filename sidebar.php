<div class="menu-principal p-3">
    ...
    <h6 class="sidebar-heading d-flex align-items-center px-3 mt-4 mb-1 text-muted text-uppercase">
        <i class="bi bi-list-columns-reverse me-2"></i> Liste și Vizualizări
    </h6>
    <hr class="mt-0 mb-2">
    ...
    <h6 class="sidebar-heading d-flex align-items-center px-3 mt-4 mb-1 text-muted text-uppercase">
        <i class="bi bi-plus-circle-fill me-2"></i> Formulare și Adăugare
    </h6>
    <hr class="mt-0 mb-2">
